...
#    endif
    ...
    void emit_copy_words(x86::Mem from,
        ...
        ASSERT(count > 0 && count < (ERTS_SINT32_MAX / sizeof(UWord)));
        ASSERT(from.offset() < ERTS_SINT32_MAX - count * sizeof(UWord));
        ASSERT(to.offset() < ERTS_SINT32_MAX - count * sizeof(UWord));
