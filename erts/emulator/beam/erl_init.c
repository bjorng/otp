...
#ifdef BEAMASM
int erts_coverage_mode = ERTS_COV_NONE;	/* -JPcover: Enable coverage */
...
void erts_usage(void)
{
    ...
    erts_fprintf(stderr, "-JPcover true|false|line_coverage|line_counters|function  enable or disable instrumentation of functions for coverage\n");
