...
ssa_opt_bsm({#opt_st{ssa=Linear0,cnt=Count0}=St, FuncDb}) ->
...
bsm_duplicate(BlockMap0, Count0) ->
                ...
                false ->
                    ...
                    {BlockMap3, Block1, Count2} =
                        case ConvergedPaths of
                            ...
                            [_|_] ->
                                {RedirectLabel, BlockMap2, Count1} =
                                    aca_copy_successors(Fail, BlockMap0, Count0, Map1),
