...
coalesce_skips({L,#b_blk{is=[#b_set{op=bs_extract}=Extract|Is0],last=Last0}=Blk0}, Bs0) ->
...
coalesce_skips_is([#b_set{op=bs_match,
                          args=[#b_literal{val=skip},Ctx0,Type,Flags,
                                #b_literal{val=Size0},#b_literal{val=Unit0}]}=Skip0,
                   #b_set{op=succeeded}],
    ...
    case Bs0 of
        [{L2,#b_blk{is=[#b_set{op=bs_match,
                               ...
                               args=[#b_literal{val=skip},_,_,_,
                                     #b_literal{val=Size1},#b_literal{val=Unit1}]},
            ...
            Skip = Skip0#b_set{dst=SkipDst,
                               args=[#b_literal{val=skip},Ctx0,Type,Flags,
                                     #b_literal{val=SkipBits},#b_literal{val=1}]},
            Is = [Skip,Succeeded],
            {Is,Br,Bs};
        [{L2,#b_blk{is=[#b_set{op=bs_test_tail,args=[_Ctx,#b_literal{val=TailSkip}]}],
