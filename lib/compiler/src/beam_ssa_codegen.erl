...
classify_heap_need(update_record, [#b_literal{val=Size} |_ ]) ->
    {put, Size + 1};
...
cg_instr(update_record, [{integer,Size}, Src | Ss0], Dst) ->
    Ss = cg_update_record_list(Ss0, []),
    [{update_record,Size,Src,Dst,{list,Ss}}].
...
cg_test(update_record=Op, Fail, Args, Dst, Set) ->
    {f,0} = Fail,                               %Assertion.
