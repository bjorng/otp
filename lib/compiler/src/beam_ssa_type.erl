...
update_arith_types_1(#b_set{op={bif,_}=Op,args=BifArgs}=I,
    ...
    case beam_call_types:arith_type(Op, ArgTypes) of
        ...
        #t_number{elements=any} ->
            {any,UnstableVars0};
        T0 ->
            case update_arith_types_safe(I, ArgTypes, T0, UnstableVars0) of
                {true,UnstableVars} ->
                    {T0,UnstableVars};
                {false,UnstableVars} ->
...
update_arith_types_2(#b_set{op={bif,'+'},args=[_,#b_literal{val=1}]},
                     [#t_integer{elements={Min,Max}}|_])
  when is_integer(Min), is_integer(Max), Max < 1 bsl 59 ->
    #t_integer{elements={Min+1,1 bsl 59}};
...
update_arith_types_safe(#b_set{}, _ArgTypes, _Type, none) ->
    ...
    {true,none};
update_arith_types_safe(#b_set{dst=Dst}=I, ArgTypes, Type0, UnstableVars0) ->
    case UnstableVars0 of
        ...
        #{} ->
            ...
            UnstableVars = UnstableVars0#{Dst => {Type0,Counter}},
            {true,UnstableVars}
    end.
