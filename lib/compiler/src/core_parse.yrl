...
struct_pattern struct_pair_patterns struct_pair_pattern
...
other_pattern -> struct_pattern : '$1'.
...
struct_pattern -> '#' atom ':' atom '{' '}' :
                      #c_struct{id = #c_literal{val={tok_val('$2'),tok_val('$4')}},
                                es = []}.
struct_pattern -> '#' atom ':' atom '{' struct_pair_patterns '}' :
                      #c_struct{id = #c_literal{val={tok_val('$2'),tok_val('$4')}},
                                es = '$6'}.
struct_pattern -> '#' '/' '{' '}' :
