...
guard_bif(is_tagged_struct, 3) -> true;
...
guard_bif(struct_get, 2) -> true;
guard_bif(struct_module, 1) -> true;
guard_bif(struct_name, 1) -> true;
guard_bif(tl, 1) -> true;
...
new_type_test(is_tagged_struct, 3) -> true;
...
bif(is_struct, 1) -> true;
bif(is_tagged_struct, 3) -> true;
bif(length, 1) -> true;
bif(link, 1) -> true;
bif(link, 2) -> true;
...
bif(struct_get, 2) -> true;
bif(struct_module, 1) -> true;
bif(struct_name, 1) -> true;
